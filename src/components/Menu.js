        ...
        <div className="menu">
            ...
            <Link onClick={() => setOpen(!open)} to='/home'>
                <button className="item">
                    ...
                    <p className="button">Pagina Inicial</p>
                </button>
            </Link>
            ...
            <Link onClick={() => setOpen(!open)} to='/search'>
                <button className="item">
                    ...
                    <p className="button">Pesquisar</p>
                </button>
            </Link>

            <Link onClick={() => setOpen(!open)} to='/home'>
                <button className="item newPost">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                    </svg>
                    <p className="button">Nova Postagem</p>
                </button>
            </Link>

            <Link onClick={() => setOpen(!open)} to='/friends'>
                <button className="item">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                    <p className="button">Amigos</p>
                </button>
            </Link>
            ...
            <Link onClick={() => setOpen(!open)} to='/settings'>
                <button className="item">
                    ...
                    <p className="button">Configurações</p>
                </button>
            </Link>
